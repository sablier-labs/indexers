...
export function getExperimentalURL(opts: { protocol: Indexer.Protocol; vendor: Indexer.Vendor }): string {
  ...
  if (vendor === "envio") {
    const id = {
      airdrops: "d7053c2", // https://envio.dev/app/sablier-labs/merkle-envio
      flow: "f465775", // https://envio.dev/app/sablier-labs/flow-envio
      lockup: "c8a9426", // https://envio.dev/app/sablier-labs/lockup-envio
    };
  ...
  if (protocol === "lockup") {
    return "https://api.studio.thegraph.com/query/112500/sablier-lockup-experimental/v2.0--v1.0.0-beta.12";
  }
