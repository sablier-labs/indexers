import { CreateLockupTranchedStream } from "../../../../bindings/SablierLockup_v4_0/SablierLockup";
import { convertTranchesV4_0 } from "../../../../helpers/lockup";
import { Store } from "../../../../store/lockup";

export function handle_SablierLockup_v4_0_CreateLockupTranchedStream(
  ...
  Store.Stream.createTranched(
    ...
    {
      tranches: convertTranchesV4_0(params.tranches),
    }
  );
}
