import { CreateLockupDynamicStream } from "../../../../bindings/SablierLockup_v4_0/SablierLockup";
import { convertSegmentsV4_0 } from "../../../../helpers/lockup";
import { Store } from "../../../../store/lockup";

export function handle_SablierLockup_v4_0_CreateLockupDynamicStream(
  ...
  Store.Stream.createDynamic(
    ...
    {
      segments: convertSegmentsV4_0(event.params.segments),
    }
  );
}
