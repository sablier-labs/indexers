import { CreateMerkleLL } from "../../bindings/SablierFactoryMerkleLL_v3_0/SablierFactoryMerkleLL";
import { SablierMerkleLL_v3_0 as TemplateLL_v3_0 } from "../../bindings/templates";
import { handleCreateMerkleLL } from "../common";

export function handle_SablierFactoryMerkleLL_v3_0_CreateMerkleLL(event: CreateMerkleLL): void {
  const params = event.params;
  const baseParams = params.campaignParams;

  handleCreateMerkleLL(
    TemplateLL_v3_0.createWithContext,
    event,
    {
