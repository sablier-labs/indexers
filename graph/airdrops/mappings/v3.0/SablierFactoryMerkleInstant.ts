...
import { CreateMerkleInstant } from "../../bindings/SablierFactoryMerkleInstant_v3_0/SablierFactoryMerkleInstant";
import { SablierMerkleInstant_v3_0 as TemplateInstant_v3_0 } from "../../bindings/templates";
import { Store } from "../../store";

export function handle_SablierFactoryMerkleInstant_v3_0_CreateMerkleInstant(
  ...
  TemplateInstant_v3_0.createWithContext(params.merkleInstant, context);
