import { CreateMerkleLL } from "../../../bindings/SablierFactoryMerkleLL_v2_0/SablierFactoryMerkleLL";
import { SablierMerkleLL_v2_0 as TemplateLL_v2_0 } from "../../../bindings/templates";
import { handleCreateMerkleLL } from "../../common";

export function handle_SablierFactoryMerkleLL_v2_0_CreateMerkleLL(event: CreateMerkleLL): void {
  const params = event.params;
  const baseParams = params.params;

  handleCreateMerkleLL(
    TemplateLL_v2_0.createWithContext,
    event,
    {
