...
import { LOCKUP_V1_0, LOCKUP_V1_1, LOCKUP_V1_2, LOCKUP_V2_0, LOCKUP_V2_1, ONE, ZERO } from "../../common/constants";
...
function addCliff(
  ...
  if (areStringsEqual(stream.version, LOCKUP_V2_0) || areStringsEqual(stream.version, LOCKUP_V2_1)) {
...
function addSegments(stream: Entity.Stream, segments: Segment[]): Entity.Stream {
  let streamed = ZERO;
...
function addTranches(stream: Entity.Stream, tranches: Tranche[]): void {
