...
} from "../../bindings/SablierLockup_v3_0/SablierLockup";
import {
  handleApproval,
...
export function handle_SablierLockup_v3_0_Approval(event: Approval): void {
...
export function handle_SablierLockup_v3_0_ApprovalForAll(event: ApprovalForAll): void {
...
export function handle_SablierLockup_v3_0_CancelLockupStream(event: CancelLockupStream): void {
...
export function handle_SablierLockup_v3_0_RenounceLockupStream(event: RenounceLockupStream): void {
  handleRenounceLockupStream(event, {
    streamId: event.params.streamId,
  });
}

export function handle_SablierLockup_v3_0_Transfer(event: Transfer): void {
