import { CreateLockupLinearStream } from "../../../bindings/SablierLockup_v2_1/SablierLockup";
import { Store } from "../../../store";

export function handle_SablierLockup_v2_1_CreateLockupLinearStream(event: CreateLockupLinearStream): void {
