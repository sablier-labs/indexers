import { CreateLockupDynamicStream } from "../../../bindings/SablierLockup_v2_1/SablierLockup";
import { convertSegmentsV2_1 } from "../../../helpers";
import { Store } from "../../../store";

export function handle_SablierLockup_v2_1_CreateLockupDynamicStream(event: CreateLockupDynamicStream): void {
  ...
  Store.Stream.createDynamic(
    ...
    {
      segments: convertSegmentsV2_1(event.params.segments),
    },
  );
}
