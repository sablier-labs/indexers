...
import { CreateLockupTranchedStreamTranchesStruct as StructTrancheV2_1 } from "../bindings/SablierLockup_v2_1/SablierLockup";
...
export function convertTranchesV2_1(eventTranches: StructTrancheV2_1[]): Tranche[] {
  return convertTranches<StructTrancheV2_1>(
    eventTranches,
    (tranche) => tranche.amount,
    (tranche) => tranche.timestamp,
  );
