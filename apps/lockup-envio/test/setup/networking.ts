...
export async function EnvioRefactored(
  ...
  return toEnvio(await request("https://indexer.hyperindex.xyz/bca1c39/v1/graphql", document, variables));
}
...
export async function TheGraphRefactored(
  ...
  return toTheGraph(await request("https://api.studio.thegraph.com/query/112500/sablier-lockup-experimental/version/latest", document, variables));
}
