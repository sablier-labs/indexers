...
Contract.Lockup.LockupLinear_v1_0.CancelLockupStream.handler(async ({ context, event }) => {
...
Contract.Lockup.LockupLinear_v1_0.CreateLockupLinearStream.handler(async ({ context, event }) => {
  await Store.User.createOrUpdate(context, event, [
    event.params.sender,
    event.params.recipient,
    event.params.funder,
...
Contract.Lockup.LockupLinear_v1_0.RenounceLockupStream.handler(async ({ context, event }) => {
...
Contract.Lockup.LockupLinear_v1_0.Approval.handler(async ({ context, event }) => {
...
Contract.Lockup.LockupLinear_v1_0.ApprovalForAll.handler(async ({ context, event }) => {
...
Contract.Lockup.LockupLinear_v1_0.Transfer.handler(async ({ context, event }) => {
