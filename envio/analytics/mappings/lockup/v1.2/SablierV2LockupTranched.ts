...
Contract.Lockup.LockupTranched_v1_2.CancelLockupStream.handler(async ({ context, event }) => {
...
Contract.Lockup.LockupTranched_v1_2.WithdrawFromLockupStream.handler(async ({ context, event }) => {
...
Contract.Lockup.LockupTranched_v1_2.Approval.handler(async ({ context, event }) => {
...
Contract.Lockup.LockupTranched_v1_2.ApprovalForAll.handler(async ({ context, event }) => {
...
Contract.Lockup.LockupTranched_v1_2.Transfer.handler(async ({ context, event }) => {
