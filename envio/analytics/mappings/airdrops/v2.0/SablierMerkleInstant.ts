...
https://github.com/sablier-labs/airdrops/blob/v2.0/src/interfaces/ISablierMerkleInstant.sol
──────────────────────────────────────────────────────────────
...
Contract.Airdrops.Campaign.MerkleInstant_v2_0.ClaimInstant.handler(async ({ context, event }) => {
