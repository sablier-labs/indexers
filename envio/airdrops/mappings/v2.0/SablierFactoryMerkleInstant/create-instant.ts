...
Contract.Factory.FactoryMerkleInstant_v2_0.CreateMerkleInstant.contractRegister(({ event, context }) => {
...
Contract.Factory.FactoryMerkleInstant_v2_0.CreateMerkleInstant.handler(async ({ context, event }) => {
